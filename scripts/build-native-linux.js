...
const archiveName = 'Aurora-Forge-v1.7.5-Linux-x64.tar.gz';
...
run(packager, ['build/runtime-staging', 'Aurora Forge', '--platform=linux', '--arch=x64', '--out=dist', '--overwrite', '--asar.unpackDir=app/tools', '--icon=app/assets/img/app-icon-256.png', '--app-version=1.7.5', '--build-version=1.7.5']);

const readme = [
  'Aurora Forge 1.7.5 — Native Linux x64', '',
  'Run:', '  ./aurora-forge', '',
